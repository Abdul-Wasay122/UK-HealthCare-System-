...
public class MainView extends JFrame {
    ...
    // FIXED: Updated to match new Patient structure with separate first/last names
    ...
    private void loadReferrals() {
        ...
        for (Referral ref : referrals) {
            Object[] row = {
                    ref.getReferralId(),
                    ref.getPatientId(),
                    ref.getReferringClinicianId(),  // FIXED: Added getter call
                    ref.getReferredToClinicianId(),
                    ref.getUrgencyLevel(),
                    ref.getReferralReason(),
                    ref.getStatus(),
                    ref.getReferralDate()  // FIXED: Added getter call
            };
    ...
    // ==================== PATIENT DIALOGS ====================
    // FIXED: Updated dialog to match new Patient constructor
    ...
    // FIXED: Removed duplicate emailField declaration and updated logic
